 ...
 const OnclikNav =(guia) =>{
        ...
        // Unifica a estrutura das guias em uma fun√ß√£o Js
...
function AcessoRapido(){
        ...
        let Pages = ['Apagar Carga','Carregar Custos com Agua','Carregar Custos com Energia','Custo com Suprimentos','Carga SUCC','Carga SOF','Unidades','EndereÁos','Centros Custo','CÛdigo de LotaÁ„o']
        let htmlContent = '';
        Pages.forEach(p=>{
